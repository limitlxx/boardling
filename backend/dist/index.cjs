...
exports.default = exports.ZcashPaywall = void 0;
Object.defineProperty(exports, "getPreset", {
  enumerable: true,
  get: function () {
    return _config.getPreset;
  }
});
...
Object.defineProperty(exports, "retryWithBackoff", {
  enumerable: true,
  get: function () {
    return _retry.retryWithBackoff;
  }
});
var _axios = _interopRequireDefault(require("axios"));
var _users = require("./api/users.js");
var _invoices = require("./api/invoices.js");
var _withdrawals = require("./api/withdrawals.js");
var _admin = require("./api/admin.js");
var _apiKeys = require("./api/apiKeys.js");
...
class ZcashPaywall {
  constructor(options = {}) {
    ...
    const config = (0, _config.resolveConfig)(options);
    ...
    this.users = new _users.UsersAPI(this.client);
    this.invoices = new _invoices.InvoicesAPI(this.client);
    this.withdrawals = new _withdrawals.WithdrawalsAPI(this.client);
    this.admin = new _admin.AdminAPI(this.client);
    this.apiKeys = new _apiKeys.ApiKeysAPI(this.client);
  }
  ...
  static withPreset(environment, overrides = {}) {
    const preset = (0, _config.getPreset)(environment);
    return new ZcashPaywall({
      ...preset,
      ...overrides
    });
  }
  ...
  static async withServerDefaults(overrides = {}) {
    const {
      getServerConfig
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('./config.js')));
  ...
  static async fromServer(baseURL, overrides = {}) {
    const {
      createWithServerConfig
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('./utils/config-fetcher.js')));
...
exports.ZcashPaywall = ZcashPaywall;
// Export for CommonJS compatibility
var _default = exports.default = ZcashPaywall;